...
def add_contact_info(name,email,mobile,other_info):
    ...
    pause(2)
    input_string("xpath","//*[@id='iaddress_MAIL_wrap']/preceding-sibling::div/input",name)
    input_string("xpath", "//*[@id='iaddress_MAIL_wrap']//div//input", email)
    input_string("xpath", "//*[@id='iaddress_TEL_wrap']//div//input", mobile)
    input_string("xpath","//textarea[@id='input_DETAIL']",other_info)
    pause(2)
